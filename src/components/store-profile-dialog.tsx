...
import { DialogDescription, DialogContent, DialogFooter, DialogHeader, DialogTitle, DialogClose } from "./ui/dialog"
...
export function StoreProfileDialog() {
    ...
    const { mutateAsync: updateProfileFn } = useMutation({
        ...
        onMutate({ name, description }) {
            ...
            return{prevriousProfile: cached}
        },
        onError(_, __, context) {
            if(context?.prevriousProfile){
                updateManagedRestaurantCache(context.prevriousProfile)
            }
        }
    })
